 ...
 <div class="mil-menu-frame">
     ...
     <div class="mil-frame-top">
         <a href="{{ route('site.home') }}" class="mil-logo">G.B.</a>
                     ...
                     <nav class="mil-main-menu" id="swupMenu">
                         <ul>
                             <li class="mil-has-children mil-active">
                                 <a href="#.">Homepage</a>
                                 <ul>
                                     <li><a href="{{ route('site.home') }}">Landing page</a></li>
                             ...
                             <div class="row">
                                 <div class="col-lg-8 mil-mb-60">
                                     ...
                                     <ul class="mil-menu-list">
                                         <li><a href="project-1.html" class="mil-light-soft">Interior design studio</a>
                                         </li>
                                         <li><a href="project-2.html" class="mil-light-soft">Home Security Camera</a>
                                         </li>
                                         <li><a href="project-3.html" class="mil-light-soft">Kemia Honest Skincare</a>
                                         </li>
