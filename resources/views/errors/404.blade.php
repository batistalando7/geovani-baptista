...
<!-- Mirrored from miller.bslthemes.com/ashley-demo/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2026 10:21:55 GMT -->
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                ...
                <div class="mil-404-banner mil-dark-bg">
                    <div class="mil-animation-frame">
                        <div class="mil-animation mil-position-4 mil-scale" data-value-1="9" data-value-2="1.4"
                            style="right: 40%;"></div>
                    </div>
                    <div class="mi-invert-fix mil-up">
                        <div class="container">
                            <div class="mil-404-frame">
                                ...
                                <h4 class="mil-404-text mil-dark mil-mb-60">Oops! Página não encontrada :(</h4>
                                <a href="{{ route('site.home') }}" class="mil-button mil-arrow-place">
