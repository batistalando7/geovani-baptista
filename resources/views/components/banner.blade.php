    ...
    <div class="mi-invert-fix">
        ...
        <div class="container">
            <div class="mil-banner-content mil-up">
                ...
                <h1 class="mil-muted mil-mb-60">PortFólio<span class="mil-thin"> de </span><br> Geovani Baptista
                    <span class="mil-thin"> </span>
                </h1>
                <div class="row">
                    <div class="col-md-7 col-lg-5">

                        <p class="mil-light-soft mil-mb-60"> Director de Arte Estratégico | Arquitectura de
                            Marca | AI-Driven Creative Direction</p>
